...
var STORE_NAME = 'suitepress_search';
 ...
 * AquilaSearch Class.
 */
var SuitepressSearch = /*#__PURE__*/function (_HTMLElement) {
  /**
   * Constructor.
   */
  function SuitepressSearch() {
    var _this;
    _classCallCheck(this, SuitepressSearch);
    _this = _callSuper(this, SuitepressSearch);
  ...
  _inherits(SuitepressSearch, _HTMLElement);
  return _createClass(SuitepressSearch);
}(HTMLElement);
var SuitepressCheckboxAccordion = /*#__PURE__*/function (_HTMLElement2) {
  /**
   * Constructor.
   */
  function SuitepressCheckboxAccordion() {
    var _this2;
    _classCallCheck(this, SuitepressCheckboxAccordion);
    _this2 = _callSuper(this, SuitepressCheckboxAccordion);
   ...
   */
  _inherits(SuitepressCheckboxAccordion, _HTMLElement2);
  return _createClass(SuitepressCheckboxAccordion, [{
...
var SuitepressCheckboxAccordionChild = /*#__PURE__*/function (_HTMLElement3) {
  /**
   * Constructor.
   */
  function SuitepressCheckboxAccordionChild() {
    var _this3;
    _classCallCheck(this, SuitepressCheckboxAccordionChild);
    _this3 = _callSuper(this, SuitepressCheckboxAccordionChild);
   ...
   */
  _inherits(SuitepressCheckboxAccordionChild, _HTMLElement3);
  return _createClass(SuitepressCheckboxAccordionChild, [{
    key: "update",
...
var SuitepressClearAllFilters = /*#__PURE__*/function (_HTMLElement4) {
  /**
   * Constructor.
   */
  function SuitepressClearAllFilters() {
    var _this4;
    _classCallCheck(this, SuitepressClearAllFilters);
    _this4 = _callSuper(this, SuitepressClearAllFilters);
    var _getState2 = getState(),
      clearAllFilters = _getState2.clearAllFilters;
    _this4.clearAllFiltersButton = _this4.querySelector('button');
    _this4.clearAllFiltersButton.addEventListener('click', function () {
      clearAllFilters();
    });
    return _this4;
  }
  _inherits(SuitepressClearAllFilters, _HTMLElement4);
  return _createClass(SuitepressClearAllFilters);
}(HTMLElement);
var SuitepressFilters = /*#__PURE__*/function (_HTMLElement5) {
  function SuitepressFilters() {
    _classCallCheck(this, SuitepressFilters);
    return _callSuper(this, SuitepressFilters, arguments);
  }
  _inherits(SuitepressFilters, _HTMLElement5);
  return _createClass(SuitepressFilters);
}(HTMLElement);
var SuitepressResultsCount = /*#__PURE__*/function (_HTMLElement6) {
  /**
   * Constructor.
   */
  function SuitepressResultsCount() {
    var _this5;
    _classCallCheck(this, SuitepressResultsCount);
    _this5 = _callSuper(this, SuitepressResultsCount);

    // Subscribe to updates.
    subscribe(_this5.update.bind(_this5));
    return _this5;
  }
  _inherits(SuitepressResultsCount, _HTMLElement6);
  return _createClass(SuitepressResultsCount, [{
    key: "update",
    value: function update() {
      var currentState = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
...
var SuitepressResults = /*#__PURE__*/function (_HTMLElement7) {
  /**
   * Constructor.
   */
  function SuitepressResults() {
    var _this6;
    _classCallCheck(this, SuitepressResults);
    _this6 = _callSuper(this, SuitepressResults);
   ...
   * @param {Object} currentState Current state.
   */
  _inherits(SuitepressResults, _HTMLElement7);
  return _createClass(SuitepressResults, [{
    key: "update",
    value: function update() {
      var currentState = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
...
var SuitepressLoadMore = /*#__PURE__*/function (_HTMLElement8) {
  /**
   * Constructor.
   */
  function SuitepressLoadMore() {
    var _this7;
    _classCallCheck(this, SuitepressLoadMore);
    _this7 = _callSuper(this, SuitepressLoadMore);
  ...
  _inherits(SuitepressLoadMore, _HTMLElement8);
  return _createClass(SuitepressLoadMore, [{
    key: "update",
    value: function update() {
      var currentState = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
...
var SuitepressLoadingMore = /*#__PURE__*/function (_HTMLElement9) {
  function SuitepressLoadingMore() {
    var _this8;
    _classCallCheck(this, SuitepressLoadingMore);
    _this8 = _callSuper(this, SuitepressLoadingMore);
    // Subscribe to updates.
    subscribe(_this8.update.bind(_this8));
    return _this8;
  }
  _inherits(SuitepressLoadingMore, _HTMLElement9);
  return _createClass(SuitepressLoadingMore, [{
    key: "update",
    value: function update() {
      var currentState = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
