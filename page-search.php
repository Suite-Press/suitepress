...
?>
    <div id="primary">
        <main id="main" class="site-main mt-5" role="main">
            <suitepress-search class="suitepress-search row px-4">
                <suitepress-filters class="col-lg-3 col-md-3 col-sm-12 pb-4">
                    <suitepress-clear-all-filters class="clear-all-filters"><button class="btn btn-secondary">Clear All filters</button></suitepress-clear-all-filters>
                    <?php foreach ( $filters_data as $filter_data ) : ?>
                        <suitepress-checkbox-accordion
                        ...
                        >
                            ...
                            <suitepress-checkbox-accordion-content class="checkbox-accordion__content">
                                <?php foreach ( $filter_data['children'] as $item ) : ?>
                                    ...
                                    <?php if ( ! empty( $item['label'] ) ) : ?>
                                        <suitepress-checkbox-accordion-child class="checkbox-accordion__child <?php echo esc_attr( $has_content_class ); ?>">
                                                ...
                                                <div class="checkbox-accordion__child-content">
                                                    <?php foreach ( $item['children'] as $child ) : ?>
                                                        ...
                                                        <?php if ( ! empty( $child['label'] ) && ! empty( $child['value'] ) ) : ?>
                                                            <suitepress-checkbox-accordion-child class="checkbox-accordion__child">
                                                                <div class="checkbox-accordion__child-handle form-field">
                                                                        ...
                                                                        <?php foreach ( $child['children'] as $grand_children ) : ?>
                                                                            ...
                                                                            <?php if ( ! empty( $grand_children['label'] ) && ! empty( $grand_children['value'] ) ) : ?>
                                                                                <suitepress-checkbox-accordion-child class="checkbox-accordion__child <?php echo esc_attr( $has_content_class ); ?>">
                                                                                    ...
                                                                                    <?php endif; ?>
                                                                                </suitepress-checkbox-accordion-child>
                                                                            <?php endif; ?>
                                                                        <?php endforeach; ?>
                                                                    </div>
                                                                <?php endif; ?>
                                    ...
                                    <?php endif; ?>
                                <?php endforeach; ?>
                            </suitepress-checkbox-accordion-content>
                        </suitepress-checkbox-accordion>
                    <?php endforeach; ?>
                </suitepress-filters>
                <div class="col-lg-9 col-md-9 col-sm-12 pb-4">
                    <suitepress-results-count class="suitepress-results-count"></suitepress-results-count>
                    <suitepress-results class="row"></suitepress-results>
                    <suitepress-loading-more class="suitepress-loading-more"></suitepress-loading-more>
                </div>
            </suitepress-search>
        </main>
    </div>
