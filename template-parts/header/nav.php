...
<nav class="navbar navbar-expand-lg navbar-light bg-light suitepress-header">
    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            if ( !empty($header_menus) && is_array($header_menus)){
                ...
                <span class="somethings-not-set-error"> No Menu set (Please set a menu to Primary Menu) </span>
            <?php }
            ?>
        </div>
